  ...
  _createClass(App, [{
    ...
    value: function componentDidMount() {
      ...
      _axios2.default.get('/api/products').then(function (res) {
        ...
        return _this2.setState({ specialProds: specialProds, regularProds: regularProds });
      });
    }
  }, {
    key: 'formSubmit',
    ...
    value: function makeRegular(product) {
      ...
      _axios2.default.put('/api/products/' + product.id, product).then(function (res) {
        ...
        return _this3.setState({ productToRegular: {} });
      });
    }
  }, {
    key: 'makeSpecial',
    value: function makeSpecial(product) {
      ...
      _axios2.default.put('/api/products/' + product.id, product).then(function (res) {
        ...
        return _this4.setState({ productToSpecial: {} });
      });
    }
  }, {
    key: 'render',
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        regularProds.map(function (product) {
          return _react2.default.createElement(
            'option',
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        specialProds.map(function (product) {
          return _react2.default.createElement(
            'option',
            { key: product.id, value: product.id },
            product.name
